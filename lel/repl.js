#!/usr/bin/env bun
// repl.js - Interactive REPL client for the `lel` audio engine.
// Usage: bun repl.js
...
// Banner
console.log('\n╔═══════════════════════════════════════════╗');
console.log('║   Aether Live REPL - Connected to lel    ║');
console.log('╚═══════════════════════════════════════════╝\n');
console.log(`Connected to: ${REPL_HOST}:${REPL_PORT}`);
...
client.on('error', (err) => {
  ...
  console.error('Is the lel engine running? (bun index.js)');
});
